...
const eventDetails = {
  title: "Mutate",
  description:
    "Mutate is a monthly event where creative minds collaborate to transform ideas into impactful products and solutions.",
  date: "Monthly",
  location: "Online",
...
const testimonials = [
  {
    ...
    role: "Participant",
    feedback:
      "Mutate helped me connect with other innovators and turn my idea into a working prototype!",
    avatar: avatar1,
    achievement: "Prototype Builder",
    rating: 5,
  },
  {
    name: "Divya S",
    role: "Mentor",
    feedback:
      "The Mutate event is a fantastic opportunity for creative minds to collaborate and grow.",
    avatar: avatar2,
    achievement: "Mentor",
    rating: 4,
  },
...
const TestimonialMutate: React.FC = () => (
  <div className={styles.pageContainer} style={{ background: "#fff" }}>
    <div style={{ textAlign: "center", marginBottom: "2rem" }}>
      ...
      <p style={{ color: "#111827" }}>
        Hear from our participants and mentors about their experience at Mutate.
      </p>
    </div>
    <div
      style={{
...
export default TestimonialMutate;
