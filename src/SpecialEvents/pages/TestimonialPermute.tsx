...
const eventDetails = {
  title: "Permute",
  description:
    "Permute is a monthly event for creative problem solvers to showcase their skills and compete in fun challenges.",
  date: "Monthly",
  location: "Online",
...
const testimonials = [
  {
    ...
    role: "Participant",
    feedback:
      "Permute helped me improve my problem-solving skills and meet new friends in the coding community.",
    avatar: avatar1,
    achievement: "Top 10",
    rating: 5,
  },
  {
    ...
    role: "Host",
    feedback:
      "Hosting Permute is always exciting. The participants bring great energy and creativity.",
    avatar: avatar2,
    achievement: "Event Host",
    rating: 4,
  },
];

const TestimonialPermute: React.FC = () => (
  <div className={styles.pageContainer} style={{ background: "#fff" }}>
    <div style={{ textAlign: "center", marginBottom: "2rem" }}>
      ...
      <p style={{ color: "#111827" }}>
        Hear from our participants and hosts about their experience at Permute.
      </p>
    </div>
    <div
      style={{
...
export default TestimonialPermute;
